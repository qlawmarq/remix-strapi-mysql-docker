...
> = ({ variant = "primary", size = "md", className, children, ...props }) => {
  ...
  const primaryClassName = `${baseClassName} text-primary-50 bg-primary-500 dark:text-primary-100 dark:bg-primary-500 hover:bg-primary-400 dark:hover:bg-primary-600 `;
  const secondaryClassName = `${baseClassName} text-gray-700 bg-gray-300 dark:text-gray-100 dark:bg-gray-400 hover:bg-gray-50 dark:hover:bg-gray-500 `;
